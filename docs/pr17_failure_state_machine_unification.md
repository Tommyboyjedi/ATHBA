...
- `e5a4a15` - unify failure decisions with the executable contract-run state machine, add typed failure routing, truthful blocked pools, resume tests, and matrix update.
